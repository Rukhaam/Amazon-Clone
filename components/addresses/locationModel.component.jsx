          ...
          <div className="mt-6 border-t pt-4">
             <div className="flex items-center gap-2">
                 <div className="border rounded-md px-2 py-1 w-full bg-white shadow-inner">
                     <input type="text" placeholder="or enter a US zip code" className="w-full text-sm outline-none" />
                 </div>
                 <button className="px-4 py-1 rounded-md border shadow-sm text-sm hover:bg-gray-100">Apply</button>
             </div>
          </div>
